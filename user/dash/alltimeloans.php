...
<head>
  ...
  <title>gPortal - All Time Loans</title>
...
$sql = "SELECT transid,loanamount,dateissued,amount_to_return,amount_returned,balance,cleared,datecleared FROM loans WHERE number=$my_number ORDER BY transid DESC";
$result = mysqli_query($link,$sql);
