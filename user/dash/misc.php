...
<head>
  ...
  <title>gPortal - Miscellaneous Expenses</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
        <p>These are the group's expenses.</p>
...
echo "<p> <font color=green font face='impact' size='5pt'>Total misc expenses is </font> <font color=red font face='impact' size='5pt'>kes $other_expenses</font> </p>";

$sql = "SELECT * FROM otherexpenses;"; 
$result = mysqli_query($link,$sql);
