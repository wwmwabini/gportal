...
<head>
  ...
  <title>gPortal - Last Five Loans</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <h1>Last Five Loans</h1>
        <hr>
        <p>Check out your last 5 loans borrowed and issued.</p>
...
$sql = "SELECT transid,loanamount,dateissued,amount_to_return,amount_returned,balance,cleared,datecleared FROM loans WHERE number=$my_number ORDER BY transid DESC LIMIT 5";
$result = mysqli_query($link,$sql);
...
echo "<td>" . $row['amount_to_return'] . "</td>";
echo "<td>" . $row['amount_returned'] . "</td>";
echo "<td>" . $row['balance'] . "</td>";
echo "<td>" . $row['cleared'] . "</td>";
echo "<td>" . $row['datecleared'] . "</td>";
echo "</tr>";
}
...
$sql2 = "SELECT UPDATE_TIME FROM   information_schema.tables WHERE  TABLE_SCHEMA = '$db'AND TABLE_NAME = 'loans'";
