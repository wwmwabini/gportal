...
<head>
  ...
  <title>gPortal - Last Five Contributions</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
        <p>Check out your last 5 contribution records to the group.</p>
...
$sql = "SELECT amount,date,week FROM contributions WHERE number=$my_number ORDER BY date DESC LIMIT 5";
$result = mysqli_query($link,$sql);
