  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<div class="mr-5">My Total Contributions</div>
                <div class="mr-5">sh. <?php echo $my_contribution?></div>
              </div>
		...
		<div class="mr-5">My Loan Balance</div>
                <div class="mr-5">sh. <?php echo $my_loanbalance?></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">View Details</span>
                <span class="float-right">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Amount Out in Loans</div>
		<div class="mr-5">sh. <?php echo $overall_loan_balance?></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">View Details</span>
                <span class="float-right">
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              <div class="card-body">
                ...
                <div class="mr-5">Cash Available</div>
		<div class="mr-5">sh. <?php echo $amount_available?></div>
              </div>
              <a class="card-footer text-white clearfix small z-1" href="#">
                <span class="float-left">View Details</span>
                <span class="float-right">
